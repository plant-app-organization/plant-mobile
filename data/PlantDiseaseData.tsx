...
`,
  ...
  lescochenilles: `Comment les identifier ?
...
Vaporiser entièrement votre plante de façon à recouvrir chaque partie de feuilles dessus, dessous/ tiges
Cette solution à base d’huile va permettre d’étouffer les cochenilles.

`,
  larouille: `Comment l’identifier ?
...
`,
  pourriture: `Comment l’identifier ?
