      ...
      <View className='w-screen h-full items-center justify-evenly '>
        ...
        <View className='h-[80%] flex flex-col justify-center m-3'>
          ...
          >
            ...
            >
              <Text className='font-antipasto text-sm text-left text-xl font-antipasto'>bio:</Text>
            </View>
            <TextInput
          ...
          >
            ...
            >
              <Text className='font-antipasto text-sm text-left text-xl font-antipasto'>Nom :</Text>
            </View>
            <TextInput
              style={{ height: 40, width: 240, fontSize: 15 }}
              value={name}
